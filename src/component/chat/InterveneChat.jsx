                ...
                <li className="chat-box">
                  <ul className="d-flex">
                    ...
                    <li className="w-100">
                      ...
                      <ul className="d-flex justify-content-between">
                        <li>
                          <h4 className="user-name-top-head m-0">
                            Chat Person
                          </h4>
                          <h4 className="user-typing-text pt-0">
                            Chat Person Name
                          </h4>
                        </li>
                        <li>
          ...
          <div className="col-md-4 b p-0">
            <div className=" scroll-div-left">
              ...
              <div className="all-chat">
                <div className="grey-text p-com">
                  <span className="chat-pre-icon">{/* <BsMessenger /> */}</span>
                  All Chat
                </div>
